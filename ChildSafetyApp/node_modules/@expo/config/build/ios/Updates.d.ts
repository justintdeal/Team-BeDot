...
export declare const withUpdates: (config: ExportedConfig, { expoUsername }: {
...
export declare function ensureBundleReactNativePhaseContainsConfigurationScript(projectRoot: string, config: Pick<ExpoConfigUpdates, 'nodeModulesPath'>, project: xcode.XcodeProject): xcode.XcodeProject;
export declare function isShellScriptBuildPhaseConfigured(projectRoot: string, config: Pick<ExpoConfigUpdates, 'nodeModulesPath'>, project: xcode.XcodeProject): boolean;
