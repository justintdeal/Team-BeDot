...
export declare function getConfigWithMods(projectRoot: string, options?: GetConfigOptions): ProjectConfig;
/**
...
export declare function getPackageJson(projectRoot: string, config?: Partial<Pick<ExpoConfig, 'nodeModulesPath'>>): PackageJSONConfig;
 ...
 * @param projectConfig
 */
export declare function getProjectConfigDescription(projectRoot: string, projectConfig: ProjectConfig): string | null;
