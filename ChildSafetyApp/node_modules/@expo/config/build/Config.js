...
function getConfigWithMods(projectRoot, options) {
    var _a;
    const config = getConfig(projectRoot, options);
    // @ts-ignore: Add the mods back to the object.
    config.exp.mods = (_a = config.mods) !== null && _a !== void 0 ? _a : null;
    return config;
}
exports.getConfigWithMods = getConfigWithMods;
/**
...
function getConfig(projectRoot, options = {}) {
    ...
    function fillAndReturnConfig(config, dynamicConfigObjectType) {
        return Object.assign(Object.assign({}, ensureConfigHasDefaultValues(projectRoot, config.expo, packageJson, options.skipSDKVersionRequirement)), { mods: config.mods, dynamicConfigObjectType,
...
function readConfigJson(projectRoot, skipValidation = false, skipNativeValidation = false) {
    ...
    return Object.assign(Object.assign(Object.assign({}, ensureConfigHasDefaultValues(projectRoot, exp, pkg, skipNativeValidation)), { mods: null, dynamicConfigPath: null, dynamicConfigObjectType: null, rootConfig: Object.assign({}, outputRootConfig) }), paths);
}
